    ...
    return (
        <div className="bg-dark min-vh-100 text-white">
            <div className="text-center">
                ...
                {recording && (
                    <>
                        <button className="btn btn-success" onClick={playRecording}>Play</button>
                        <button className="btn btn-danger" onClick={() => setRecording("")}>Clear</button>
...
function Pad({ clip, volume, setRecording }) {
    ...
    return (
        <div onClick={playSound} className={`btn btn-secondary p-3 m-1 border ${active && "btn-warning"}`}>
